...
namespace Wurk.Infrastructure.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Tags = table.Column<string>(type: "nvarchar(3500)", maxLength: 3500, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUserClaims_ArtGalleryUser_ArtGalleryUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUserLogins_ArtGalleryUser_ArtGalleryUserId",
                        column: x => x.ArtGalleryUserId,
                        principalTable: "ArtGalleryUser",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUserRoles_ArtGalleryUser_ArtGalleryUserId",
                        column: x => x.ArtGalleryUserId,
                        principalTable: "ArtGalleryUser",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Comments", x => new { x.BlogPostId, x.UserId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventsOrders", x => new { x.EventId, x.UserId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_EventsOrders_Events_EventId",
                        column: x => x.EventId,
                        principalTable: "Events",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArtsOrders", x => new { x.UserId, x.ArtId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUserClaims_ArtGalleryUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUserLogins_ArtGalleryUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUserRoles_ArtGalleryUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventsOrders_IsDeleted",
                table: "EventsOrders",
                column: "IsDeleted");
